...
class App extends BaseConfig
{
     ...
     * @var string
     */
    public $baseURL = 'https://doitv2.test.local/';
     ...
     * @var string
     */
    public $sessionCookieName = 'doit_sess';
     ...
     * @var string
     */
    public $CSRFTokenName = '_olimpussValidation';
     ...
     * @var string
     */
    public $CSRFCookieName = '_olimpussSecurity';
