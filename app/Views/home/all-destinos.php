...
?>
				...
				<div class="col-lg-6 justify-content-center py-4 destino" id="destino-id-<?= $destino->id; ?>">
					<a target="_self" href="<?= base_url('destino/' . $destino->destino_slug); ?>">
						<div class="single-project justify-content-center">
							...
							<div class="project-content justify-content-center">
								<a class="project-title" target="_self" href="<?= base_url('destino/' . $destino->destino_slug); ?>">
									<?= str_replace($replaceViewValues->find2Replace, $replaceViewValues->replace2Found, $destino->destino_titulo); ?>
								</a>
								<?= !empty($destino->destino_subtitulo)?'<span class="project-subtitle"><a target="_self" href="'. base_url('destino/' . $destino->destino_slug). '">'.str_replace($replaceViewValues->find2Replace, $replaceViewValues->replace2Found, $destino->destino_subtitulo).'</a></span>':''; ?>
							</div>
						</div>
					</a>
				</div>
